    ...
    <section className="flex flex-col">
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-green-200/60">
          ...
          <div className="flex items-center border-2 border-dashed border-green-400 rounded-lg px-2.5 py-1.5">
            <span className="text-[9px] uppercase tracking-wider text-gray-500 font-semibold mr-1.5 leading-tight">Balance:</span>
