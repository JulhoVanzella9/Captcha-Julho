...
export function FlowHeader() {
  ...
  return (
    <header className="flex items-center justify-between py-3 mb-1 bg-gray-50 -mx-4 px-4 rounded-b-2xl">
      {/* Logo */}
      ...
      {/* Balance */}
      <div className="flex flex-col items-center border-2 border-dashed border-green-400 rounded-lg px-3 py-1.5">
        <span className="text-[9px] uppercase tracking-wider text-gray-500 font-semibold leading-tight">Your Current Balance:</span>
