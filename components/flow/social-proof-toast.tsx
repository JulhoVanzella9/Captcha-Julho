...
export function SocialProofToast() {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-[0_4px_16px_rgba(0,0,0,0.12)] border border-[#dadce0] px-4 py-3 flex items-center gap-3">
        {/* Google G icon */}
        ...
        <div className="flex-1 min-w-0">
          <p className="text-[13px] font-medium text-[#202124] leading-snug">{message}</p>
          <p className="text-[11px] text-[#5f6368] mt-0.5">{timeAgo}</p>
        </div>
      </div>
    </div>
  )
