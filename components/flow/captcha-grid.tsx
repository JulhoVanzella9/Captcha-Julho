...
const captchaImages: CaptchaImage[] = [
  ...
  { id: 8, src: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=150&h=150&fit=crop&q=80", isSelected: true },
  ...
  return (
    <div className="bg-[#f8f9fa] rounded-2xl border border-[#dadce0] p-4 flex flex-col gap-3 shadow-[0_1px_3px_rgba(0,0,0,0.08),0_4px_12px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex items-center gap-2 px-1">
        ...
        <span className="text-sm font-medium text-[#5f6368]">Google Security Verification</span>
      </div>
