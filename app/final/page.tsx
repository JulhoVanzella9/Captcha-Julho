...
import { Volume2, ThumbsUp, Eye, Clock } from "lucide-react"
          ...
          {visibleCommentsCount < comments.length && (
            <div className="px-4 pb-3">
              <button
                ...
                className="w-full text-center text-sm text-[#1877f2] font-medium py-2 hover:text-[#1557b0] transition-colors"
              >
                View more comments... ▾
              </button>
            </div>
